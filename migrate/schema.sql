CREATE TABLE "notes" ("id" VARCHAR NOT NULL, "reaction_id" VARCHAR, "user_id" VARCHAR, "reaction_name" VARCHAR, "text" VARCHAR, "created_at" TIMESTAMP, PRIMARY KEY ("id"), FOREIGN KEY ("reaction_name") REFERENCES "reactions" ("name") ON UPDATE NO ACTION ON DELETE NO ACTION, FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
...
CREATE TABLE "files" ("id" VARCHAR NOT NULL, "name" VARCHAR, "url" VARCHAR, "thumbnail_url" VARCHAR, "created_at" TIMESTAMP, PRIMARY KEY ("id"));
