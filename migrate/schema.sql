CREATE TABLE "notes" ("id" VARCHAR NOT NULL, "user_id" VARCHAR, "reaction_name" VARCHAR, "text" VARCHAR, "created_at" TIMESTAMP, PRIMARY KEY ("id"), FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, FOREIGN KEY ("reaction_name") REFERENCES "reactions" ("name") ON UPDATE NO ACTION ON DELETE NO ACTION);
